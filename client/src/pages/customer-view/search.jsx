...
import { fetchProductDetails } from "@/store/customer/products-slice";
import {
  getSearchResults,
  resetSearchResults,
} from "@/store/customer/search-slice";
...
const SearchProducts = () => {
  ...
  const { searchResults } = useSelector((state) => state.customerSeach);
  const { productDetails } = useSelector((state) => state.customerProducts);
